    ...
    return(
        <>
         <Hspace></Hspace>
                ...
                <div className=" templates bg-green-50 hover:bg-green-100 hover:scale-105 cursor-pointer hover:border-2 border-green-500 hover:ring transition-all duration-300 py-4  hover:translate-y-3 -translate-y-3">
                ...
                <div className="py-2">
                    <button className={`flex ${iconsColors.classical.bg_class} hover:bg-green-200 
                    transition-all duration-300 items-center content-center`}>
                    <IconHolder backgroundColor={`${iconsColors.classical.icon_holder_bg}`} padding="10px" borderRadius="10px">
                    
                    <FaSearchPlus color={`${iconsColors.classical.color}`}></FaSearchPlus>
                    </IconHolder>
