...
const CreativeLayouts = () => {
    return (
        <>
            <Hspace></Hspace>
            <TemplatesdescriptionCard title={templateDescription.creative.title} description={templateDescription.creative.description}></TemplatesdescriptionCard>
            <div className="grid grid-cols-1 overflow-hidden  gap-4" id="creative">
            ...
            <div className="py-2">
                <button className={`flex ${iconsColors.creative.bg_class} hover:bg-green-200 
                                                transition-all duration-300 items-center content-center`}>
                    <IconHolder backgroundColor={`${iconsColors.creative.icon_holder_bg}`} padding="10px" borderRadius="10px">
                        <FaSearchPlus color={`${iconsColors.creative.color}`}></FaSearchPlus>
                    </IconHolder>
