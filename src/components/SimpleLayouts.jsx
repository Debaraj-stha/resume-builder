...
const SimpleLayouts = () => {
    return (
        <>
            ...
            <div className="grid grid-cols-1  gap-4" id="simple">
            ...
            <div className="py-2">
                <button className={`flex ${iconsColors.simple.bg_class} hover:bg-green-200 
                                    transition-all duration-300 items-center content-center`}>
                    <IconHolder backgroundColor={`${iconsColors.simple.icon_holder_bg}`} padding="10px" borderRadius="10px">

                        <FaSearchPlus color={`${iconsColors.simple.color}`}></FaSearchPlus>
                    </IconHolder>
