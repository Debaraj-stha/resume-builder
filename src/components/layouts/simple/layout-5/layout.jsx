...
const SimpleLayout5 = memo((props) => {
  const {
    watch
  } = useFormContext();
  ...
  const sectionData = getSimpleLayout5SectionData(key_val,2)
  ...
  return (
    <div className="w-full max-w-full">
      <LayoutUi sectionRefs={sectionRefs} key_val={key_val} pages={pages} layoutId={5} layout_type="simple"  />
    </div>
  );
});
