...
import getSimpleLayout6SectionData from "../layout-output/layout-6-output";




const SimpleLayout6 = memo((props) => {
  const {
    watch
  } = useFormContext();
  ...
  const sectionData = getSimpleLayout6SectionData(key_val,6)
  ...
  return (
    <div className="w-full max-w-full">
      <LayoutUi sectionRefs={sectionRefs} key_val={key_val} pages={pages} layoutId={6} layout_type="simple"  />
    </div>
  );
});

export default SimpleLayout6;
