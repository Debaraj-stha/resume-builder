...
const ModernLayouts = () => {
    return (
        <>
            ...
            <div className="py-2">
                <button className={`flex ${iconsColors.modern.bg_class} hover:bg-green-200 
                                    transition-all duration-300 items-center content-center`}>
                    <IconHolder backgroundColor={`${iconsColors.modern.icon_holder_bg}`} padding="10px" borderRadius="10px">

                        <FaSearchPlus color={`${iconsColors.modern.color}`}></FaSearchPlus>
                    </IconHolder>
